...
const REPORTS = [
  ...
  },
  {
    ...
    description: "Análise do ano fiscal com gráfico de barras mensal e comparação por colaborador.",
  ...
  },
  {
    ...
    description: "Registo completo de todas as alterações de taxas horárias com deltas e auditoria.",
...
export function AdminReportsView() {
  ...
  return (
    <>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1 mt-2">
                    {r.tags.map(tag => (
                      <span key={tag} className="text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-white/50 dark:bg-white/5 border border-current/10 text-muted-foreground/60">
                        {tag}
                      </span>
                    ))}
                  </div>
      ...
      <RateHistoryModal    open={open === "rate-history"} onClose={() => setOpen(null)} />
    </>
  )
}
