...
import { EstadoBadge } from "@/components/admin/obras/estado-badge"
import { FotoUploader } from "@/components/admin/obras/foto-uploader"
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
        ...
        >
          ...
          {/* Search */}
          <div className="px-4 py-3 border-b border-border/40 shrink-0 overflow-x-auto" style={{scrollbarWidth:"none"}}>
